...
<p style="text-align: justify;">
Par ailleurs, afin de faciliter l'appropriation des outils, un jeu de données de test a été inclus dans `data(chronique_exemple)`. La structure des tables utilisées à proprement parler est également disponible dans `data(chronique_structure_hors_bdd)`.
</p>
